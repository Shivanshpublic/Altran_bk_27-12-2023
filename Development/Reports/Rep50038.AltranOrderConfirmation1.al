report 50038 "Altran Sales - Order Conf.1"
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    RDLCLayout = 'Layouts/Final/StandardSalesOrderConf1.rdl';
    //WordLayout = 'Layouts/AltranSalesOrderConf1.docx';
    //WordLayout = 'Layouts/StandardSalesOrderConf1.docx';
    DefaultLayout = RDLC;
