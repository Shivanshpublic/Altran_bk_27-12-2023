REPORT 50024 "Certificate of Origin US"
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    RDLCLayout = 'Layouts/Final/CertificateofOriginUSCanada.rdl';
    Caption = 'Certificate of Origin US & Canada';
            ...
            DATAITEM(CopyLoop; Integer)
            {
                ...
                DATAITEM(PageLoop; Integer)
                {
                    ...
                    DATAITEM(SalesInvoiceLine; "Sales Invoice Line")
                    {
                        ...
                        column(Origin_Criteria; "Origin Criteria")
                        {

                        }
                        column(Certification_Indicator; "Certification Indicator")
                        {

                        }
                        column(USMCA_Qualified_Y_N; "USMCA Qualified Y/N")
                        {
                    ...
                    DATAITEM(ParentSalesInvoiceLine; "Sales Invoice Line")
                    {
                        ...
                        column(POrigin_Criteria; "Origin Criteria")
                        {

                        }
                        column(PCertification_Indicator; "Certification Indicator")
                        {

                        }
                        column(PUSMCA_Qualified_Y_N; "USMCA Qualified Y/N")
                        {
    ...
    VAR
        ...
        FooterText: Label 'I certify that the goods described in this document qualify as originating and the information contained in this document is true and accurate. I assume responsibility for proving such representations and agree to maintain and present upon request or to make available during a verification visit, documentation necessary to support this certification';
        UserEmail: Text;
        YellowColor: Boolean;
}