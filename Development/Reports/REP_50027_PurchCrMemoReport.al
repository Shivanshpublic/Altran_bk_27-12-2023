REPORT 50027 "Purchase Cr. Memo Report"
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    RDLCLayout = 'Layouts/Final/PurchaseCrMemp_Report.rdl';
    Caption = 'Purchase Cr. Memo Report';
    EnableHyperlinks = true;
    DATASET
    {
        DATAITEM(PurchaseHeader; "Purch. Cr. Memo Hdr.")
        {
            ...
            DATAITEM(CopyLoop; Integer)
            {
                ...
                DATAITEM(PageLoop; Integer)
                {
                    ...
                    DATAITEM(PurchaseLine; "Purch. Cr. Memo Line")
                    {
                        ...
                        COLUMN(UnitPrice; "Direct Unit Cost")
                        {
                            ...
                            AutoFormatExpression = '1,' + FORMAT(GetCurrencyCodeL(PurchaseHeader."Currency Code"));
                            //AutoFormatType = 10;
                        }
                ...
                BEGIN
                    ...
                    if PurchaseHeader."Ship-to Code" = '' then begin
                        ...
                        ShiptoCountryRegionCode := CompanyInfo."Country/Region Code";
                    end else begin
                        ...
                        ShiptoCountryRegionCode := PurchaseHeader."Ship-to Country/Region Code";
                    end;
