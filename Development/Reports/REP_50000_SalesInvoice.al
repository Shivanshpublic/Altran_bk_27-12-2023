REPORT 50000 "Sales Invoice"
{
    ...
    ApplicationArea = All;
    RDLCLayout = 'Layouts/Final/SalesInvoice.rdl';
        ...
        DATAITEM(SalesInvoiceHeader; "Sales Invoice Header")
        {
            ...
            DATAITEM(CopyLoop; Integer)
            {
                ...
                DATAITEM(PageLoop; Integer)
                {
                    ...
                    column(DueDate; Format(SalesInvoiceHeader."Due Date", 0, '<Month,2>/<Day,2>/<Year4>')) { }
                    ...
                    column(OrderNumber; SalesInvoiceHeader."Order No.")
                    {
