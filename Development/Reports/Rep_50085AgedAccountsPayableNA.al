report 50085 "Aged Accounts Payable NA1"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Layouts/Final/AgedAccountsPayableNA1.rdl';
    ApplicationArea = Basic, Suite;
    //ApplicationArea = All;
    Caption = 'Aged Accounts Payable - Altran';
        ...
        dataitem(Header; "Integer")
        {
            ...
            dataitem(Vendor; Vendor)
            {
                ...
                begin
                    ...
                    SubTitle := copystr(SubTitle + AgedAsOfLbl + ' ' + Format(PeriodEndingDate[1], 0, 5) + ')', 1, MaxStrLen(SubTitle));
    ...
    var
        ...
        "BalanceDue$": array[5] of Decimal;
        ColumnHead: array[5] of Text[20];
        ColumnHeadHead: Text[59];
        PercentString: array[5] of Text[10];
        Percent: Decimal;
        ...
        VendTotAmountDue: array[5] of Decimal;
        ...
        GrandBalanceDue: array[5] of Decimal;
    ...
    begin
        ...
        ExcelBuf.WriteSheet(CompanyName(), CompanyName, UserId());
        ExcelBuf.CloseBook();
        ExcelBuf.SetFriendlyFilename(AgedAccountsPayableLbl);
        ExcelBuf.OpenExcel();
    end;
}