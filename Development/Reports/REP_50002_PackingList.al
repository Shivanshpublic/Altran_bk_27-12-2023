REPORT 50002 "Packing List"
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    RDLCLayout = 'Layouts/Final/PackingList_INT.rdl';
    Caption = 'Packing List International';
        ...
        DATAITEM(SalesShipmentHeader; "Sales Invoice Header")
        {
            ...
            DATAITEM(CopyLoop; Integer)
            {
                ...
                DATAITEM(PageLoop; Integer)
                {
                    ...
                    COLUMN(SellToCity; AddSpaceOrComma(SalesShipmentHeader."Sell-to City", ', '))
                    {
                    }
                    ...
                    DATAITEM(SalesShipmentLine; "Sales Invoice Line")
                    {
                        ...
                        column(Gross_Weight; "Total Gross (KG)")
                        {

                        }
                        column(Net_Weight; "Total Net (KG)")
                        {
