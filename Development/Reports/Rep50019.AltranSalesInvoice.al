report 50019 "Altran Sales - Invoice"
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    //WordLayout = 'Layouts/AltranSalesInvoice.docx';
    RDLCLayout = 'Layouts/StandardSalesInvoice.rdl';
    WordLayout = 'Layouts/StandardSalesInvoice.docx';
    ...
    dataset
    {
        dataitem(Header; "Sales Invoice Header")
        {
            ...
            column(YourReference_Header_Lbl; 'Customer PO No.')
            {
            }
            ...
            column(OrderNo_Lbl; 'Sales Order No.')
            {
            }
            ...
            dataitem(Line; "Sales Invoice Line")
            {
                ...
                column(ItemNo_Line; "Description 2")
                {
                }
            ...
            dataitem(Totals; "Integer")
            {
                ...
                column(TotalAmountExclInclVATText; 'Total (USD)')
                {
                }
    ...
    begin
        ...
        FillNameValueTable(LeftHeader, 'Customer PO No.', Header."External Document No.");
        ...
        FillNameValueTable(LeftHeader, 'Sales Order No.', Header."Order No.");
