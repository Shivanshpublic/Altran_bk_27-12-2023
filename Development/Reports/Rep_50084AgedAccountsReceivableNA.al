report 50084 "Aged Accounts Receivable NA1"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Layouts/Final/AgedAccountsReceivableNA.rdl';
    ApplicationArea = Basic, Suite;
    Caption = 'Aged Accounts Receivable - Altran';
    ...
    var
        ...
        CustTotAmountDue: array[5] of Decimal;
    ...
    begin
        ...
        ExcelBuf.CloseBook();
        ExcelBuf.SetFriendlyFilename(AgedAccountsReceivableLbl);
        ExcelBuf.OpenExcel();
    end;
