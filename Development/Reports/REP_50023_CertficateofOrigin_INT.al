REPORT 50023 "Certificate of Origin INT"
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    RDLCLayout = 'Layouts/Final/CertificateofOriginINT.rdl';
    Caption = 'Certificate of Origin International';
            ...
            DATAITEM(CopyLoop; Integer)
            {
                ...
                DATAITEM(PageLoop; Integer)
                {
                    ...
                    DATAITEM(SalesInvoiceLine; "Sales Invoice Line")
                    {
                        ...
                        column(AWBNumber; GetAWBNumber("Shipment Tracking Code"))
                        {
    ...
    local procedure GetAWBNumber(ShipmentCode: Code[20]): Text
    var
        ShipmentTracking: Record "Tracking Shipment Header";
    begin
        if ShipmentCode <> '' then begin
            ShipmentTracking.GET(ShipmentCode);
            exit(ShipmentTracking."Freight Details");
        end else
            exit('');
    ...
    VAR
        ...
        FooterText: Label 'The Chamber of Commerce of Sterling, a recognized Chamber of Commerce under the laws of the state of ILLINOIS, has examined the manufacturer''s invoice or shipper''s affidavit concerning the origin of the merchandise and, according to the best of my knowledge find that the products originated in CHINA. All sales of %1 products and services are subject to %1 then current Standard Terms and Conditions of Sale unless otherwise expressly agreed to by %1 in writing(and not merely as an acknowledgment of any preprinted terms included on its purchase orders or other correspondence)';
        UserEmail: Text;
        YellowColor: Boolean;
}