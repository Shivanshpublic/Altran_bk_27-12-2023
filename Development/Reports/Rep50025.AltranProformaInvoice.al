report 50026 "Altran Proforma_Invoice"
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    RDLCLayout = 'Layouts/Final/Proforma_Invoice.rdl';
    DefaultLayout = RDLC;
    Caption = 'Altran Proforma Invoice';
    ...
    dataset
    {
        dataitem(Header; "Sales Header")
        {
            ...
            column(QuoteNo; RecSalesperson.Name)
            {
            }
            ...
            dataitem(ParentLine; "Sales Line")
            {
                ...
                column(ParentLineNo_Line; "Parent Line No.")
                {
                }
