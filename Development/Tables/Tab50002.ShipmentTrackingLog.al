TABLE 50002 "Tracking Shipment Log"
{
    ...
    FIELDS
    {
        ...
        FIELD(11; "New Arrival Date"; Date)
        {
            ...
            begin
                ...
                //"Delayed by Days" := CalcDate(("New Arrival Date" - "Date of Dispatch") - "Delivery Lead Time"; //To be corrected
            end;
        }
        ...
        FIELD(24; "Delivery Lead Time"; DateFormula)
        {
            DataClassification = ToBeClassified;
            Editable = false;
        }
    ...
    begin
        //Rec."Delayed by Days" := ("Date of Arrival" - "Date of Dispatch") - "Delivery Lead Time"; //To be corrected
    end;
            ...
            repeat
                ...
                IF ShipmentTrackingLine.FINDFIRST THEN BEGIN
                    REPEAT
                        ...
                        ShipmentTrackingLog."Total CBM" := ShipmentTrackingLine."Total CBM";
